...
Public Class StanfordApp
    ...
    Sub RenderDateOfBirth(rs)
        Try
            ...
            Response.Write("<select id=""q1-" & rs("id") & """ style=""width:95px;"" name=""q1-" & rs("id") & """ ")
            ...
            Response.Write("<select id=""q2-" & rs("id") & """ style=""width:66px;"" name=""q2-" & rs("id") & """ ")
            If rs("required") = True Then Response.Write("class=""validate[required] required"" ")
            Response.Write(">")
            ...
            Response.Write("<select id=""q3-" & rs("id") & """ style=""width:66px;"" name=""q3-" & rs("id") & """ ")
            If rs("required") = True Then Response.Write("class=""validate[required] required"" ")
            Response.Write(">")
    ...
    Sub RenderState(rs)
        ...
        If rs2.Read() Then
            Response.Write("<div class=""item""><div class=""item-label"">" & rs("label") & "</div>")
            Response.Write("<div class=""item-controls""><select name=""q" & rs("id") & """>")
            Response.Write("<option selected=""selected"" class=""group-title"" value=""null"">PLEASE SELECT</option>")
            Do
                Response.Write("<option value=""" & rs2("id") & """")
                If CStr(subValue) = CStr(rs2("id")) Then Response.Write(" selected=""selected"" ")
    ...
    Sub RenderSalutation(rs)
        ...
        If rs2.Read() Then
            ...
            If rs("required") = True Then Response.Write("class=""validate[required] required"" ")
            Response.Write(">")
            Response.Write("<option  class=""group-title"" value="""">PLEASE SELECT</option>")
